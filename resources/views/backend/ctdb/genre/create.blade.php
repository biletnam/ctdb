...
@section('content')
    {{ html()->form('POST', route('admin.ctdb.genre.store'))->class('form-horizontal')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            {{ html()->label(__('validation.attributes.backend.ctdb.genres.name'))->class('col-md-2 form-control-label')->for('name') }}
