...
@section ('title', __('ctdb.backend.type.headings.management') . ' | ' . __('ctdb.backend.type.headings.create'))
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">{{ __('ctdb.backend.type.headings.create') }}</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
