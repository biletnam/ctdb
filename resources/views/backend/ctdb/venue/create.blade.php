                    ...
                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label"
                                           for="description">{{ __('ctdb.backend.venue.fields.labels.description') }}</label>
                                    <div class="col-md-10">
                        ...
                        <div class="row mt-2 mb-2">
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label"
                                           for="facebooklink">{{ __('ctdb.backend.venue.fields.labels.facebooklink') }}</label>
                                    <div class="col-md-10">
                                        <input class="form-control"
                                               type="url"
                                               name="facebooklink"
                        ...
                        <div class="row mt-2 mb-2">
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label"
                                           for="twitterlink">{{ __('ctdb.backend.venue.fields.labels.twitterlink') }}</label>
                                    <div class="col-md-10">
                                        <input class="form-control"
                                               type="url"
                                               name="twitterlink"
                        ...
                        <div class="row mt-2 mb-2">
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label"
                                           for="youtubelink">{{ __('ctdb.backend.venue.fields.labels.youtubelink') }}</label>
                                    <div class="col-md-10">
                                        <input class="form-control"
                                               type="url"
                                               name="youtubelink"
                        ...
                        <div class="row mt-2 mb-2">
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-md-2 form-control-label"
                                           for="instagramlink">{{ __('ctdb.backend.venue.fields.labels.instagramlink') }}</label>
                                    <div class="col-md-10">
                                        <input class="form-control"
                                               type="url"
                                               name="instagramlink"
