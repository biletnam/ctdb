...
@section ('title', __('ctdb.backend.licensor.headings.management') . ' | ' . __('ctdb.backend.licensor.headings.edit'))
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">{{ __('ctdb.backend.licensor.headings.edit') }}</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                <!--row-->
