...
use App\Events\Backend\Ctdb\Genre\CompanyTypeCreated;
use App\Events\Backend\Ctdb\Genre\CompanyTypeDeleted;
use App\Events\Backend\Ctdb\Genre\CompanyTypeUpdated;

/**
 * Class GenreFormTest.
 */
class GenreFormTest extends BrowserKitTestCase
{
    public function testCreateGenreRequiredFieldsAll()
    {
        // All Permissions
        $this->actingAs($this->admin)
             ->visit('/admin/ctdb/genre/create')
             ->type('', 'name')
             ->press('Create')
             ->seePageIs('/admin/ctdb/genre/create')
