...
trait GenreAttribute
{
    ...
    {
        return '<a href="'.route('admin.ctdb.genre.edit', $this).'" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.ctdb.genre.destroy', $this).'"
			 data-method="delete"
