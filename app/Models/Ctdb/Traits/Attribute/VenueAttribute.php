...
trait VenueAttribute
{
    ...
    {
        return '<a href="'.route('admin.ctdb.venue.edit', $this).'" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.ctdb.venue.destroy', $this).'"
			 data-method="delete"
