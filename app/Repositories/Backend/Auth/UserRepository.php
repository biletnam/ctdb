...
class UserRepository extends BaseRepository
{
    ...
    public function update(User $user, array $data) : User
    {
        ...
        $this->checkUserByScreenName($user, $data['screen_name']);
     ...
     * @throws GeneralException
     */
    protected function checkUserByScreenName(User $user, $screenName)
    {
        //Figure out if screen name is not the same
        if ($user->screen_name != $screenName) {
            //Check to see if screen name exists
            if ($this->model->where('screen_name', '=', $screenName)->first()) {
                throw new GeneralException(trans('exceptions.backend.access.users.screen_name_error'));
            }
        }
    }
}
