...
class UserRepository extends BaseRepository
{
    ...
    public function update($id, array $input, $image = false)
    {
        ...
        if ($user->screen_name != $input['screen_name']) {
            if ($this->getByColumn($input['screen_name'], 'screen_name')) {
                throw new GeneralException(__('exceptions.frontend.auth.screen_name_taken'));
            }
        }
